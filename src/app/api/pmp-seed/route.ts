...
const QUESTIONS = [
  // LOT 1 FACILE
  {id:1,lot:1,level:"facile",domain:"Processus",pmbok:"standards de gestion de projet",question:"Quelle est la première étape du cycle de vie d'un projet ?",options:["Planification","Initiation","Exécution","Clôture"],correct:1,explanation:"L'initiation est la première phase. Elle définit les objectifs, nomme le chef de projet et produit la charte de projet."},
  {id:2,lot:1,level:"facile",domain:"Processus",pmbok:"standards de gestion de projet",question:"Qu'est-ce que la Charte de Projet (Project Charter) ?",options:["Le planning détaillé","Le document qui autorise officiellement le projet et nomme le CP","Le contrat client","Le registre des risques"],correct:1,explanation:"La charte de projet autorise officiellement le projet, définit les objectifs et donne l'autorité au chef de projet."},
  {id:3,lot:1,level:"facile",domain:"Personnes",pmbok:"standards de gestion de projet",question:"Qui est responsable de la réussite globale du projet ?",options:["Le sponsor","Le chef de projet","L'équipe","Le client"],correct:1,explanation:"Le chef de projet est responsable de la réussite. Il coordonne l'équipe, gère les risques et communique avec les parties prenantes."},
  ...
  {id:14,lot:1,level:"facile",domain:"Processus",pmbok:"standards de gestion de projet",question:"Qu'est-ce qu'un jalon (milestone) ?",options:["Une tâche critique","Un point significatif ou événement important, de durée zéro","Un membre clé","Un livrable intermédiaire"],correct:1,explanation:"Un jalon est un point remarquable du planning, de durée zéro, marquant l'achèvement d'une phase importante."},
  {id:15,lot:1,level:"facile",domain:"Processus",pmbok:"standards de gestion de projet",question:"Qu'inclut la clôture de projet ?",options:["Uniquement la livraison finale","Leçons apprises, archivage, libération des ressources et acceptation formelle","La signature du contrat initial","La nomination de la nouvelle équipe"],correct:1,explanation:"La clôture inclut : acceptation formelle, leçons apprises, archivage et libération des ressources."},
]
