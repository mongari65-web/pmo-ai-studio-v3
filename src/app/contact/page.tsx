...
export default function ContactPage() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: '#f8fafc', minHeight: '100vh', padding: '60px 5%' }}>
      <div style={{ maxWidth: 640, margin: '0 auto' }}>

        {/* Header */}
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, textDecoration: 'none', marginBottom: 32 }}>
            <div style={{ width: 36, height: 36, borderRadius: 9, background: 'linear-gradient(135deg,#1e40af,#7B5EFF)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 900, fontSize: 16 }}>P</div>
            <span style={{ fontSize: 16, fontWeight: 800, color: '#0f172a' }}>PMO AI Studio</span>
          </Link>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                <div>
                  ...
                  <input
                    ...
                    placeholder="Abdelhafid T."
                    style={{ width: '100%', padding: '10px 14px', borderRadius: 10, border: '1px solid #e2e8f0', fontSize: 14, outline: 'none', boxSizing: 'border-box', background: '#f8fafc' }}
                  />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 6 }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <select
                  ...
                  style={{ width: '100%', padding: '10px 14px', borderRadius: 10, border: '1px solid #e2e8f0', fontSize: 14, outline: 'none', background: '#f8fafc', color: form.subject ? '#0f172a' : '#94a3b8' }}>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <textarea
                  ...
                  style={{ width: '100%', padding: '10px 14px', borderRadius: 10, border: '1px solid #e2e8f0', fontSize: 14, outline: 'none', resize: 'vertical', boxSizing: 'border-box', background: '#f8fafc', fontFamily: 'inherit' }}
                />
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  background: status === 'loading' ? '#94a3b8' : 'linear-gradient(135deg,#1e40af,#3b82f6)',
