      ...
      <div style={{ background:"var(--bg)", minHeight:"100%" }}>
        ...
        <div style={{ maxWidth:1100, margin:"0 auto", padding:"32px 24px", display:"grid", gridTemplateColumns:"1fr 280px", gap:32 }}>
          ...
          <article>
            ...
            {/* Partage bas de page — mêmes icônes SVG que le header */}
            <div style={{ marginTop:28, padding:"16px 20px", background:"var(--bg-card)", border:"1px solid var(--border)", borderRadius:12 }}>
              ...
              <div style={{ display:"flex", gap:8, flexWrap:"wrap", alignItems:"center" }}>
                <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://pmo-ai-studio-v3.vercel.app/blog/"+slug)}`} target="_blank" rel="noopener noreferrer" title="LinkedIn"
                  style={{ width:42, height:42, borderRadius:"50%", background:"#0A66C2", display:"flex", alignItems:"center",                   style={{extD                  sty                    vg                  sw3                  stox="0 0 24 24" width="20" height="20"><path fill="#fff" d="M6.5 8.5H3v11h3.5v-11zm-1.75-1.5a2 2 0 110-4 2 2 0 010 4zM21 19.5h-3.5v-5.5c0-1.3-.9-2-1.8-2-1 0-1.7.8-1.7 2v5.5H10.5v-11H14v1.5c.5-.9 1.7-1.8 3-1.8 2.5 0 4 1.7 4 4.5v6.8z"/></svg>
                </a>
                <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("📊 "+article.title+" par @AbdelhafidTouil #PMO #PMP #PMBOK")}&url=${encodeURIComponent("https://pmo-ai-studio-v3.vercel.app/blog/"+                <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("📊le={{ width:42, height:42, borderRadius:"50%", background:"#000", display:"flex", alignItems:"center", justifyContent:"center", textDecoration:"none" }}>
...
Lire l'article complet : https://pmo-ai-studio-v3.vercel.app/blog/"+slug)}`} target="_blank" rel="noopener noreferrer" title="WhatsApp"
...
"+article.excerpt)}`} target="_blank" rel="noopener noreferrer" title="Telegram"
                  style={{ width:42, height:42, borderRadius:"50%", background:"#229ED9", display:"flex", alignItems:"center", justifyContent:"center", textDecoration:"none" }}>
                  <svg viewBox="0 0 24 24" width="20" height="20" fill="#fff"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-                  44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
                </a>
                <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" tit                <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" tit                <a href="https://www.instagram.com/" target="_blank" rel="noo alignItems:"center", justifyContent:"center", textDecoration:"none" }}>
                  <svg viewBox="0 0 24 24" width="20" height="20" fill="#fff"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4                  <6.                  <svg viewBox="0 0 24 24" width="20" height="20" fill="#fff"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.05tt

Cordialement,
Abdelhafid TOUIL, PMP®")}`} target="_blank" rel="noopener noreferrer" title="Gmail"
                  style={{ width:42, height:42, borderRadius:"50%", background:"#EA4335", display:"flex", alignItems:"center", justifyContent:"center", textDecoration:"none" }}>
