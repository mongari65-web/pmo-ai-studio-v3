              ...
              <div style={{ display:"flex", alignItems:"center", gap:5, flexWrap:"wrap" }}>
                ...
                {[
                  { bg:"#0A66C2", href:`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://pmo-ai-studio-v3.vercel.app/blog/"+slug)}`, label:"LinkedIn",
                    svg:<img src="/icons/linkedin.png" alt="LinkedIn" style={{width:24,height:24,objectFit:"contain"}}/> },                    svg:<svg viewBox="0 0 24 24" width="16" height="16" fill="#fff"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> },
