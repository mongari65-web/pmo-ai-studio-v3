  ...
  },
  {
    ...
    content: [
      { subtitle: "Plan de révision recommandé (3-4 mois)", items: [
        "Mois 1 : Maîtriser le guide de gestion de projet 7e édition — focus sur les 8 domaines de performance",
      ...
      { subtitle: "Ressources recommandées", items: [
        "📖 guide de gestion de projet 7e édition (inclus avec l'inscription PMI)",
        ...
        <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:24 }}>
          <div>
            ...
            <p style={{ fontSize:13, color:"var(--text-2)", margin:0 }}>
              Tout ce qu'il faut savoir pour réussir votre certification chef de projet du premier coup
            </p>
          </div>
