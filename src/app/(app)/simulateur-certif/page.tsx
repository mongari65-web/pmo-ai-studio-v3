...
export default function PMPSimulatorPage() {
  ...
  return (
    <AppLayout>
    <ProGate feature="pmp-simulator" featureLabel="Simulateur Certifications 225 questions">
          ...
          <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
            <div>
              ...
              <p style={{ fontSize:13, color:"var(--text-2)", margin:"4px 0 0" }}>
                225 questions · 3 niveaux · 15 lots de 15 questions · standards de gestion de projet + Agile · Seuil : 61%
