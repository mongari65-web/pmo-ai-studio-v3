...
export default function ForgotPasswordPage() {
  ...
  const fieldStyle: React.CSSProperties = {
    width:"100%", padding:"11px 14px", background:"#0F1022",
    border:"1px solid rgba(255,255,255,0.12)", borderRadius:8,
    color:"#F0F2FF", fontSize:14, outline:"none", boxSizing:"border-box",
  }

  return (
    <div style={{ m    <div style={{ m    <div sty0A    <div style={{ m    <div style={{ m    <div sty0,     <div style={{ m    <divyContent:"center",
      padding:24, fontFamily:"'      padding:24, fontFamily:"'      padde=      padding:24, fontFamily:"'      padding:2        padding:24, fontFamily:"'      paddingay      padding:24, fontFamily:"'      paddIcon size={64}/></div>
        <h1 style={{ fontSize:22, fontWeight:800, color:"#F0F2FF", margin:"0 0 6px" }}>PMO AI Studio</h1>
        <p style={{ fontSize:13, color:"#5A5F80", margin:0 }}>L&apos;outil PMO qui transforme vos projets en succès</p>
      </div>

      <div style={{ width:"100%", maxWidth:420, background:"#111320",
        border:"1px solid rgba(255,255,255,0.08)", borderRadius:16, padding:"28px 32px" }}>

        {sent ? (
          <div style={{ textAlign:"center" }}>
            <div style={{ fontSize:48, marginBottom:16 }}>📧</div>
            <h2 style={{ fontSize:18, fontWeight:700, color:"#F0F2FF", margin:"0 0 12px" }}>Email envoyé !</h2>
          ...
          <>
            <h2 style={{ fontSize:18, fontWeight:700, color:"#F0F2FF", margin:"0 0 8px" }}>Mot de passe oublié</h2>
            ...
            <form onSubmit={handleReset}>
              ...
              <button type="submit" disabled={loading}
                style={{ width:"100%", padding:"12px", background:"linear-gradient(135deg,#7B5EFF,#5B3EDF)",
            ...
            <p style={{ textAlign:"center", marginTop:20, paddingTop:20,
              borderTop:"1px solid rgba(255,255,255,0.08)", fontSize:13, color:"#5A5F80" }}>
